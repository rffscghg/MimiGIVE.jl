...
@defcomp Damages_RegionAggregatorSum_NewSectorDamages begin
    ...
    damage_new_sector = Parameter(index=[time, ag_mapping_input_regions], unit="billion US\$2005/yr")
    ...
    damage_new_sector_regions = Variable(index=[time, ag_mapping_output_regions], unit="billion US\$2005/yr")
    ...
    function run_timestep(p, v, d, t)
        ...
        v.damage_new_sector_regions[t, :] .= 0.
